...
* 增加功能选项：`精简模式`，开启后将关闭并隐藏以下QYL主题功能，仅保留配色选择
    * QYL主题设置面板的所有功能
    * QYL所有自定义属性样式
    * 部分元素样式
        * 开启精简模式后，相应功能不再影响性能
...
* **精简模式**：开启后将关闭并隐藏以下QYL主题功能，仅保留配色选择以最大化提升性能
    * QYL主题设置面板的所有功能
    * QYL所有自定义属性样式
    * 部分元素样式
    <details>
...
#### 问题排查
* 若QYL自定义属性样式不生效，请先任意勾选QYL主题设置面板的某一选项（勾选后可取消）来更新配置文件，然后重启思源
* 若开启精简模式后，有主题功能未被关闭，请先取消精简模式，然后：重启思源，再次开启精简模式
