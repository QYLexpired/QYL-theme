...
* light-dark二合一，共19种主题配色

* light配色：经典、夕阳、森林、海洋、糖果、薰衣草、云雾、霜禾、回忆、湖畔、香雪兰

* dark配色：经典、勃艮第、玄青、墨翠、灰幕、赤霞、苔雪、暮霭
...
* 小彩蛋：给文档/块设置自定义属性`link-style`的值为`按钮`，这个文档的块/该块内的所有超链接、块引链接、pdf标注链接变为按钮样式
