...
<p style="opacity: 0.7; font-weight: bold; font-size: 15px">V4.1.7</p>
<p style="opacity: 0.7; font-weight: bold; font-size: 14px; padding-left: 1em">• 重做<span data-type="code" style="padding: 0 0.4em">显示行内备注</span>，大幅优化侧边备注的效果<br>• 实现浏览器地址栏/移动端PWA在配色切换时状态栏颜色自动同步</p>
