...
function enableQYLburgundy() {
    ...
    styleSheet.innerText = `
        ...
        :root {
            ...
            --b3-theme-primary-lightest: rgba(163, 76, 76, 0.22); /* 主色0.1透明度 */
...
function enableQYLxuanqing() {
    ...
    styleSheet.innerText = `
        ...
        :root {
            ...
            --b3-theme-primary-lightest: rgba(87, 83, 173, 0.22); /* 主色0.1透明度 */
            --b3-protyle-inline-mark-background: rgba(81, 150, 92, 0.8);/* 标记色 */
            --b3-protyle-inline-mark-color: #dadada; /* 标记文字色 */
            --b3-border-color: var(--b3-theme-surface-lighter); /* 线条色 */
...
function enableQYLmocui() {
    ...
    styleSheet.innerText = `
        ...
        :root {
            ...
            --b3-theme-primary-lightest: rgba(82, 132, 80, 0.22); /* 主色0.1透明度 */
            --b3-protyle-inline-mark-background: rgba(81, 150, 92, 0.8);/* 标记色 */
            --b3-protyle-inline-mark-color: #dadada; /* 标记文字色 */
            --b3-border-color: var(--b3-theme-surface-lighter); /* 线条色 */
...
function enableQYLhuimu() {
    ...
    styleSheet.innerText = `
        ...
        :root {
            ...
            --b3-theme-primary-lightest: rgba(135, 123, 93, 0.22); /* 主色0.1透明度 */
            --b3-protyle-inline-mark-background: rgba(81, 150, 92, 0.8);/* 标记色 */
            --b3-protyle-inline-mark-color: #dadada; /* 标记文字色 */
            --b3-border-color: var(--b3-theme-surface-lighter); /* 线条色 */
...
function enableQYLchixia() {
    ...
    styleSheet.innerText = `
        ...
        :root {
            ...
            --b3-theme-primary-lightest: rgba(128, 99, 168, 0.22); /* 主色0.1透明度 */
            --b3-protyle-inline-mark-background: rgba(81, 150, 92, 0.8);/* 标记色 */
            --b3-protyle-inline-mark-color: #dadada; /* 标记文字色 */
            --b3-border-color: var(--b3-theme-surface-lighter); /* 线条色 */
