...
export function initFusionOn() {
    ...
    styleElement.textContent = `
        ...
        .layout__center [data-type="wnd"] > .fn__flex:first-child {
            & > .layout-tab-bar {
                background-color: transparent;
                ...
                &.layout-tab-bar--readonly {
                    ...
                    -webkit-app-region: drag;
                    app-region: drag;
                    & :is([data-type="new"], [data-type="more"]) {
                        -webkit-app-region: no-drag;
                        app-region: no-drag;
                    }
                }
    ...
    function adjustFusionTopMargin() {
        ...
        fusionTopElements.forEach((fusionTop, index) => {
            ...
            if (fusionTopRect.left < dragRect.left) {
                ...
                if (flexElement.style.marginLeft) {
            ...
            if (fusionTopRect.right > dragRect.right) {
                ...
                if (flexElement.style.marginRight) {
